...
void render_text_labels(void) {
    printf("DEBUGRR: render_text_labels - START\n");
    ...
    if (mtx == NULL) {
        sTextLabelsCount = 0;
        printf("DEBUGRR: render_text_labels - END - mtx == NULL\n");
    ...
    printf("DEBUGRR: render_text_labels - sTextLabelsCount: %d\n", sTextLabelsCount);

    for (i = 0; i < sTextLabelsCount; i++) {
        for (j = 0; j < sTextLabels[i]->length; j++) {
            printf("DEBUGRR: render_text_labels - glyphIndex: %c\n", sTextLabels[i]->buffer[j]);
    ...
    printf("DEBUGRR: render_text_labels - END\n");
}
